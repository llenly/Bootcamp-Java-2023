...
public class OracleJDBC {
	...
	public final static String URL = "jdbc:oracle:thin:@curso2023.gestionproyectos.com";
	public final static String DATABASE = "SystemRemoto";
	public final static String USUARIO = "LLN_alumno";
